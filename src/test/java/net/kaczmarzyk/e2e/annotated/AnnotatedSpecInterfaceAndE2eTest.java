...
public class AnnotatedSpecInterfaceAndE2eTest extends E2eTestBase {
    ...
    private interface LastNameAndSpec extends Specification<Customer> {
    }

    // TC-3. interface without any spec extending by param spec
    private interface InterfaceWithoutAnySpec extends Specification<Customer> {
    }

    // TC-4. interface without any spec extending interface with @And spec
    private interface InterfaceWithoutAnySpecExtendedByLastNameAndSpec extends LastNameAndSpec {
    }
    ...
    private interface GenderAndFirstNameLikeSpecAndLastNameSpec extends LastNameAndSpec {
    }
    ...
    private interface GenderAndFirstNameLikeSpec extends Specification<Customer> {
    }
    ...
    private interface FirstNameLike2Spec extends GenderAndFirstNameLikeSpec {
    }
    ...
    private interface FilterWithAndSpecExtendedByTwoFilters extends FirstNameLike2Spec, LastNameAndSpec {
    }
