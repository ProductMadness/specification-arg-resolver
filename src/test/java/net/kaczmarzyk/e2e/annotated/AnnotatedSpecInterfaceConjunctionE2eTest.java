...
public class AnnotatedSpecInterfaceConjunctionE2eTest extends E2eTestBase {
    ...
    private interface LastNameOrFirstNameAndGenderFilter extends Specification<Customer> {
    }
    ...
    // TC-3. interface without any spec extending interface with @Conjunction spec
    private interface EmptyFilterExtendingInterfaceWithConjunctionSpec extends LastNameOrFirstNameAndGenderFilter {
    }
    ...
    private interface ConjunctionFilterExtendedByOtherConjunctionFilter extends LastNameOrFirstNameAndGenderFilter {
    }
