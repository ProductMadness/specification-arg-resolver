...
public class AnnotatedSpecInterfaceOrE2eTest extends E2eTestBase {
    ...
    private interface GenderOrFirstNameSpec extends Specification<Customer> {
    }
    ...
    // TC-4. interface without any spec extending interface with @Or annotation
    private interface EmptyFilterExtendingInterfaceWithOrSpec extends GenderOrFirstNameSpec {
    }

    // TC-5. interface with @Or spec extending other interface with @Or spec
    private interface LastNameOrNickNameAndGenderOrFirstNameSpec extends GenderOrFirstNameSpec {
