...
public class AnnotatedSpecInterfaceJoinsE2eTest extends E2eTestBase {
    ...
    private interface ItemNameOrBadgeTypeFilter extends Specification<Customer> {
    }

    // TC-3. interface without any spec extended by param spec
    private interface EmptyFilter extends Specification<Customer> {
    }
    ...
    private interface EmptyFilterExtendingInterfaceWithJoinsSpec extends ItemNameOrBadgeTypeFilter {
    ...
    private interface BadgeTypeFilter extends Specification<Customer> {
    }
    ...
    private interface CustomJoinsFilterExtendingOtherJoinsFilter extends BadgeTypeFilter {
    }
