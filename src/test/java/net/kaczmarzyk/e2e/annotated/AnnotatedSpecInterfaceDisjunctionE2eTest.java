...
public class AnnotatedSpecInterfaceDisjunctionE2eTest extends E2eTestBase {
    ...
    private interface LastNameAndGenderOrFirstNameFilter extends Specification<Customer> {
    }
    ...
    // TC-3. interface without any spec extending interface with @Disjunction spec
    private interface EmptyFilterExtendingInterfaceWithDisjunctionSpec extends LastNameAndGenderOrFirstNameFilter {
    }
    ...
    private interface DisjunctionFilterExtendedByOtherDisjunctionFilter extends LastNameAndGenderOrFirstNameFilter {
    }
