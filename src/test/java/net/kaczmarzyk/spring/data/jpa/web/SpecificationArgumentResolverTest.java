...
public class SpecificationArgumentResolverTest extends ResolverTestBase {
    ...
    public void resolvesJoinFetchForSimpleSpec() throws Exception {
        ...
        assertThat(innerSpecs(resolved))
                .hasSize(2)
                .contains(new Like<Object>(queryCtx, "path1", "value1"))
    ...
    public void resolvesRepeatedFetchJoins() throws Exception {
        ...
        assertThat(innerSpecs(resolved))
                .hasSize(2)
                .contains(new Like<>(queryCtx, "path1", "value1"))
    ...
    public interface CustomSpec extends Specification<Object> {
    }

    @JoinFetch(paths = {"fetch1"})
    @JoinFetch(paths = {"fetch2"})
    @Spec(path = "path1", spec = Like.class)
    public interface CustomSpecRepeatedFetch extends Specification<Object> {
    }
    ...
    @Spec(path = "path1", spec = Like.class)
    public interface CustomSpecJoinContainer extends Specification<Object> {
    }
